...
<template>
    <AuthenticatedLayout>
       <h2 class="py-2 text-2xl font-bold"> Add Banner</h2>
       <form @submit.prevent="submit()" method="post" class="my-4">
            ...
            <button type="submit" class="absolute right-0 px-8 py-2 mt-2 text-sm font-semibold text-white bg-blue-800 border border-gray-500 top-2 rounded-xl">Add to Banner</button>
        </form>
    </AuthenticatedLayout>
</template>